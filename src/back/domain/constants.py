...
# Похований Імператор. За глосарієм правил він «рахується за одну карту всіх
# чотирьох фракцій» — і для цілей здібностей, і при розв'язанні нічиї. Своєї
# здібності не має й нічого не рухає, тому в каталозі стоїть окремою фракцією.
JOKER_FACTION = "Joker"
